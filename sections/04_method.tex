...
Second, an angle-regression head predicts a continuous value whenever the decoder produces a dedicated \texttt{<ANGLE>} token.
...
To supply structured geometry, we append exactly $K$ special \texttt{<GEO>} placeholders in a fixed canonical order.
