...
and metric extraction described in Sec.~\ref{sec:dataset}. Accordingly,
...
features in the standard LLaVA input sequence.
...
$9^\circ$ SmoothL1 transition in degree space. The language term is
causal cross-entropy with label smoothing. Domain-knowledge records contain
...
At inference time, SAM 3D Body reconstruction provides the ordered
