...
We address this limitation by pairing images with explicit body-geometry metadata and conditioning a vision--language model on it to capture meaning changes hidden in subtle visual differences.
