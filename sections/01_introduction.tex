...
A dedicated \texttt{<ANGLE>} mechanism separates the decision to place a numeric slot from continuous scalar regression and feeds the predicted value back into the autoregressive context.
