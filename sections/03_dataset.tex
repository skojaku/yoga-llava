...
Fig.~\ref{fig:sam3d_examples} in Appendix~\ref{app:reconstruction_examples} shows representative reconstructions.
...
Table~\ref{tab:domain_knowledge_representation} in Appendix~\ref{app:annotation_sets} summarizes both representations.
