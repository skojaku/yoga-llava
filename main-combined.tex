...
We reconstruct a 3D body from each image, then extract structured geometric descriptors, and finally generate two QA sets grounded in either pose-level textual knowledge or image-specific geometry.
...
An LLM-based extractor first converts each chunk $c_i$ into two evidence representations:
\begin{equation}
...
The model therefore verbalizes a predefined evidence path.
