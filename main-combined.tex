...
Yoga-82 provides no reconstructed 3D bodies, no interpretable geometric descriptors, and no question--answer annotations that connect a specific image to its measured configuration.
